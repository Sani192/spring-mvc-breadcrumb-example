...
public class EmployeeManagementController {
	...
	public ModelAndView iig(HttpServletRequest request) {
		String screen = request.getParameter("screen");
		String method = request.getParameter("method");
		
		ModelAndView model = new ModelAndView();
		if(screen.equals("1") && method.equals("homepage")) {
			model.setViewName("list-employee");
		} else if(screen.equals("2") && method.equals("about-us")) {
			model.setViewName("about-us");
		} else if(screen.equals("3") && method.equals("contact-us")) {
